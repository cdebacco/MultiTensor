...
void print_graph_stat(std::vector<Graph_undirected> );
...
int main(int ac, char** av)
{
  ...
  vector<Graph_undirected> A(L);  // a vector of graphs, one for each of the L layers; local variable 
...
/* ----------------RESULTS VARIABLES ----------------*/
  ...
  iterate_undirected(assortative,N_real,err, inf,initialization,maxit,tolerance,decision,file, end_file,w_file,A,u_list,u,u_f,u_old);
